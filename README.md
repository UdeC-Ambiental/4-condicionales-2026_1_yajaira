...
| `reto1_temperatura.ipynb` | Clasificación térmica y riesgo |Kelly Fonseca |
| `reto2_ph.ipynb` | Evaluación de pH y alerta química | Kelly Fonseca |
| `reto3_oxigeno.ipynb` | Análisis biológico por oxígeno | Valentina Saavedra|
| `reto4_integracion.ipynb` | Diagnóstico final integrando variables | Santiago Benavides|
